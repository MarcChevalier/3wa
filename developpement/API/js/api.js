...
// var CEQUEJAITAPEDANSMONINPUT = document.getElementById("movies").value;
// $.getJSON('https://api.themoviedb.org/3/search/movie?api_key=2ee2c5b569240ea2a2a879dd9c8a822c&query=' + CEQUEJAITAPEDANSMONINPUT, recupFilm);
// });
//
...
//     $("#list").append('<p>' + response.results[i].title +'</p>' );
//       i = i ++;
//   }
//
// };
